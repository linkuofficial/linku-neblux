...
> **2026-07-14 工程基線：**Graph Atlas WP0／WP0.5／WP1／WP2／WP3 已完成；WP4 Atlas Prototype 已實作、自審優化並通過 Atlas 45／45、全站 E2E 80／80、browser desktop／390×844／DPR 2 檢查，待一輪跨家族 review。WP5 Renderer v2 preflight 已完成，branch `codex/graph-atlas-wp5`、brief `docs/tasks/2026-07-14-graph-atlas-wp5-renderer-v2-core.md`；WP4 review gate 關閉後可直接實作。現行 production entries 仍使用 legacy runtime 與 `frontend/src/engine/`；WP4 只建內部 `/atlas-v2.html`，WP5 也只建並存 core/lab，不先切 production。
